    ...
    <div>
        ...
        
        {
          forLoginPage ? (
            ...
            <div className={`admin-content__wrapper w-screen h-screen mx-auto ${isSidebarOpen ? "pl-3 lg:pl-60" : "pl-20 lg:pl-20"} sm:pl-20 pt-20 pr-3 pb-3 font-sans transition-all duration-200 ease-in`}>
