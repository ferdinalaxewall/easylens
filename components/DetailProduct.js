...
function DetailProduct({name, image, description, prices}) {
    ...
    const handleSelectButton = (button) => {
        ...
        setSelectPrice(button.getAttribute("data-price"))
        setVariant(button.getAttribute("variant-value"))
    }
    const orderWhatsapp = () => {
    ...
    return (
        <div className="detail-produk__content">
                    ...
                    <div className="detail-produk__price">
                        { selectPrice !== "" && (
                            <>
                                ...
                                <h1 className="price__number highlighted-text">Rp. {selectPrice}</h1>
                            </>
                        )}
                        <button className="book-produk" onClick={() => orderWhatsapp()} disabled={selectPrice === "" ? true : false}>
            ...
            <div className="detail-produk__sub-main" data-aos="fade-down">
